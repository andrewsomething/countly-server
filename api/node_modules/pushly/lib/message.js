 ...
 */
var Status = {
    Initial:        0,          // Nothing happened yet
    InQueue:        1 << 1,     // Master level
    InProcessing:   1 << 2,     // Worker level
    Done:           1 << 3,     // Done on worker level 
    Error:          1 << 4,     // Some error occurred during processing
    Aborted:        1 << 5,     // Unrecoverable (credentials or message format) error occurred, or you just send message abort request
};
...
var Message = function (opts) {
    ...
    this.content = {
        ...
        sound: opts.content.sound || undefined,
        badge: opts.content.badge || undefined,
    };
        ...
        compileWithMessage: {
            value: function(platform, message) {
                ...
                if (platform === Platform.APNS) {
                    ...
                    if (this.content.delayWhileIdle) {
                        compiled.delay_while_idle = this.content.delayWhileIdle;
                    }
...
//                    compiled.c = JSON.stringify(this.content.data);
        ...
        compile: {
            value: function(platform) {
                if (this.content.messagePerLocale) {
                    var content = {};
